			<script language="javascript">
				...
				<div class="page_detail">
					...
					<div class="clr"></div>
					<form method="post" action="<?php echo base_url();?>user/user_registration/page4_data_1" name="student_detail4" id="student_detail2">		<!---->
					<table cellpadding="0" class="c_form" cellspacing="5">
						...
						<tr>
							<td colspan="2"><textarea name="other_info2" id="other_info2" style="width:665px;" title="Information about yourself" required ></textarea></td>
						</tr>
						<tr>
							<td colspan="2">
