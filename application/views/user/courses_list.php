						...
						<tr>
							...
							<table cellpadding="0" width="100%" border="0" cellspacing="0">
								...
								?>
                                    ...
                                    <!--<td align="right"><a href="<?php echo base_url();?>user/courses_detail/editcourse/<?php echo $result->id;?>">Edit</a></td>-->
                                    <td align="right"><a href="<?php echo base_url();?>user/courses_detail/deletecource/<?php echo $result->id;?>">Delete</a></td>
                                    <td align="right"><a href="<?php echo base_url();?>user/courses_detail/editcourse/<?php echo $result->id;?>">Edit</a></td>
									<td width="20"></td>
								</tr>
