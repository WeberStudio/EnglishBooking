			...
			<div style="float:left;">
				...
				<div class="page_detail">
					<div class="headig">Student Login Here</div>
					<div class="line_c"></div>
					<div class="clr"></div>
					<form method="post" action="<?php echo base_url();?>user/student_login/login" name="cust_login" id="cust_login">
					<table cellpadding="0" class="c_form" cellspacing="5">
						<tr><td colspan="2" height="20"></td></tr>
						<tr>
							<td colspan="2"><h1>Enter Login Information</h1></td>
						</tr>
						<tr><td colspan="2" height="20"></td></tr>
						<tr>
						...
						<tr>
							<td colspan="2" align="center"><input type="submit" name="Submit" value="Submit" /> &nbsp;-&nbsp; <a href="<?php echo base_url();?>user/student_dashboard/forget_password">Forget Password</a></td>
