<script language="javascript">
				...
				$(document).ready(function() {
					// Handler for .ready() called.
						$('input[type=password]').password_strength(5);
					});
				function pass(){
				...
				<div class="page_detail">
					...
					<div class="clr"></div>
					<form method="post" action="<?php echo base_url();?>user/user_registration/page6_data_1" name="student_detail2" id="student_detail2">		<!---->
					<table cellpadding="0" class="c_form" cellspacing="5">
						...
						<tr>
							<td><div id="msg" style="color:#F00;"></div></td>
						</tr>
						<tr>
							<td>Password</td>
						</tr>
