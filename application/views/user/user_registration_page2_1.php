<div class="page_detail">
					...
					<div class="clr"></div>
					<form method="post" action="<?php echo base_url();?>user/user_registration/page2_data_1" name="student_detail2" id="student_detail2">		<!---->
					<table cellpadding="0" class="c_form" cellspacing="5">
						...
						<tr>
							...
							<table width="535" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td>
										<select name="year" style="width:100px" required title="Select Date of Birth" >
						...
						<tr>
							<td><input type="text" name="nationality" id="nationality" placeholder="Nationality" required title="Country Name" /></td>
						</tr>
<!--						<tr>
							<td>Address</td>
						</tr>
...
-->						<tr>
							...
							<table cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td></td>
									<td><input type="text" name="state" style="width:245px" title="Couty" /></td>
								</tr>
								<tr>
									<td>Nationality</td>
									<td width="20"></td>
