 ...
 <div class="right_content">            
    ...
    <h2>News letter subscriber  List</h2> 
            <a class="bt_blue" href="<?php echo base_url();?>admin_main/letter/getnewslettercsv"><span class="bt_blue_lft"></span><strong>Download Newsletter CSV</strong><span class="bt_blue_r"></span></a>                             
