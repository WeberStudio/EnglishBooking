<script language="javascript">
	function onclickevent(val1){
      ...
      var value = val1;
        	...
        	$.ajax({
                type: "GET",
                url: "<?php echo base_url();?>admin_main/ranking/populercolleges_update",
                data: {
                    'collegeID': value,
                    'status':val2
                },
...
//    $(function() {
//        $( "#startdate_collegeofday" ).datepicker();
//
//    });
$(function() {
 ...
 <div class="right_content">        
    <h2>Popular College List</h2> 
     <tabel><tr>
                <td>
                    <form name="s_form"  id="s_form" method="post" action="<?php echo base_url(); ?>admin_main/ranking/populercolleges">
		...
		<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
			<thead>
				<tr>
					...
					<th scope="col" class="rounded">Popular college's</th>
				</tr>
			</thead>
			   <!-- <tfoot>
				<tr>
			 ...
			 ?>
				<tr>
					...
					<td><?php echo $result->useremail;?></td>
                                        <td align="center">
                                            <input type="checkbox" name="stauscheck" id="pop_<?php echo $result->id; ?>" onclick="return onclickevent(<?php echo $result->id; ?>);"  <?php if($this->rankings->getcheckedcollege($result->id)=='1'){ echo "checked='checked'";}?>>
                                            <!--<input type="text" size="20" value="<?php echo $this->rankings->getcollegeofdaydate($result->id); ?>" name="startdate_collegeofday" id="startdate_collegeofday<?php echo $result->id; ?>"  onchange="return onclickevent(<?php echo $result->id; ?>,this.value);" class="usedatepicker"/> 
