...
function onclickevent(val1){
      ...
      var value = val1;
        	...
        	$.ajax({
                type: "GET",
                url: "<?php echo base_url();?>admin_main/ranking/updaterecommendedcourse",
                data: {
                    'courseid': value
                },
                dataType: "text",
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
	...
	?>
    	<tr>
            ...
            <td align="center">  <input type="radio" name="stauscheck" id="pop_<?php echo $course_res->id; ?>" onclick="return onclickevent(<?php echo $course_res->id; ?>);"  <?php if($checked==$course_res->id){ echo "checked='checked'";}?>> 
