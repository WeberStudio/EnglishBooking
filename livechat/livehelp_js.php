...
<?php } ?>
 		...
 		<?php if($usetable=="Y"){ ?>
 	   var newHTML =  '<table cellpadding=0 cellspacing=0 border=0><tr><td valign=top align=center><a name="chatRef" href="javascript:openLiveHelp(<?php echo intval($UNTRUSTED['department']); ?>)" onclick="javascript:csTimeout_<?php echo $department; ?>=0;"><img name="csIcon" src="http://192.168.1.100/jamshaid/CodeIgniter/theme/user-images/lc.jpg" alt="Live Help" border="0"></a></td></tr>';
 
 	   newHTML = newHTML + '</table>';
 	   
    <?php } else { ?>
 	    var newHTML =  '<a name="chatRef" href="javascript:openLiveHelp(<?php echo intval($UNTRUSTED['department']); ?>)" onclick="javascript:csTimeout_<?php echo $department; ?>=0;"><img name="csIcon" src="http://192.168.1.100/jamshaid/CodeIgniter/theme/user-images/lc.jpg" alt="Live Help" border="0"></a>';
